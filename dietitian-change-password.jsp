...
<body class="host_version">
	...
	%>
	<jsp:include page="dietition-side-header.jsp"></jsp:include>
	<div class="container">
			...
			<div class="col-md-6 col-sm-6 col-xs-12">
				...
				<div class="panel panel-info">
					...
					<div class="panel-body">
						<form role="form" action="DietitionChangePassword" method="post">
							<%
								ResultSet resultset = DatabaseConnection.getResultFromSqlQuery("select * from tbldietitian where uname='"+ session.getAttribute("uname") + "'");
							...
							<div class="form-group">
								<label>New Password</label> <input class="form-control"
									type="password" name="password" value="" placeholder="New Password"/>
							</div>
							<div class="form-group">
								<label>Confirm Password</label> <input class="form-control"
									type="password" name="confpass" value="" placeholder="Confirm Password"/>
							</div>
